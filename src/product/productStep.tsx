...
import { useNomenclatureSearch } from "../common/tempqueries";
...
export const ProductsStep: React.FC<ProductsStepProps> = ({
   ...
   const { data: searchResults = [] } = useNomenclatureSearch(debouncedSearch);
