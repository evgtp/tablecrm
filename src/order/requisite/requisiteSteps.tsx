         ...
         <Row gutter={12}>
            <Col span={12}>
               <Form.Item
                  ...
                  help={
                     !draft.organization_id ? "выберите организацию" : undefined
                  }
               >
                  <Select
                     showSearch
            ...
            <Select
               ...
               notFoundContent={
                  payboxesLoading ? (
                     ...
                     "Начните вводить название счета"
                  )
               }
               filterOption={false}
            />
         </Form.Item>
         {searchInput && payboxesLoading && (
            <div
               style={{
                  textAlign: "center",
                  marginTop: 8,
            ...
            >
               ...
               Ищем счета по запросу: "{searchInput}"
            </div>
         )}
      </>
   );
